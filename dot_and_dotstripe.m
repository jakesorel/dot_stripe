...
%% params
seed = 1;
D0 = 1.15*0.15*[0.01 0.2 0.0075 0.15];
D0 = 1.2*0.15*[0.01 0.2 0.0075 0.15];
...
m = simulate_rd_growth(D, df, seed, tfin, tw, L0, Lf, W, "compareModels/dot_stripe/jaws", DLIMS, tplot);
...
D = D0;
m = simulate_rd_growth(D, df, seed, tfin, tw, L0, Lf, W, "compareModels/dot_stripe/ladder", DLIMS, tplot);
...
D = 1.5*D0;
m = simulate_rd_ichth(D, df, seed, tfin, tw, L0, Lf, W, "compareModels/dot_stripe/lattice", DLIMS, tplot);
...
function m = simulate_rd_ichth(D, df, seed, tfin, tw, L0, Lf, W, filenm, DLIMS, tplot)
