...
alpha = 0.00;
m = simulate_rd_growth(D, df, seed, tfin, tw, L0, Lf, W, 'doubleGrowth', DLIMS, tplot,alpha,10,2);

%%

alpha = 0.002;
m = simulate_rd_growth(D, df, seed, tfin, tw, L0, Lf, W, 'doubleGrowth', DLIMS, tplot,alpha,10,5);
...
tw = 20000;
alpha = 0.00;
m = simulate_rd_growth_long(D, df, seed, tfin, tw, L0, Lf, W, 'doubleGrowth', DLIMS, tplot,alpha,10,2);


%% bigger 2
smallerFactor = .8;
W = 10*smallerFactor;
D = sqrt(smallerFactor) * D0;
Lf = 40;
